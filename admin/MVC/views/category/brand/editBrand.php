<div class="row">
    <div class="col-12 col-lg-12">
        <div class="card">
            <div class="card-header">Bảng sửa thương hiệu
                ...
                <div class="page-addProduct">
                    <div class="form-wrap px-3 py-4">
                        <div class="main-form pt-3">
                            <form action="?act=thuonghieu&sub=update&condition=idTH" method="post" class="form-group" enctype="multipart/form-data">
                                <input type="hidden" name="id" placeholder="Mã sản phẩm" class="form-control mb-3" value="<?=$data['idTH']?>">
                                <input type="hidden" name="sub-id" value="idTH">
                               <div class="mb-3">
                                    <label for="">Tên sản phẩm</label>
                                    <input type="text" name="name" id="" value="<?= $data['tenTH'] ?>" placeholder="Tên sản phẩm" class="form-control mb-3">
                                    <input type="hidden" name="sub-name" value="tenTH">
                               </div>
                                <div class="img1 mb-3">
                                    <img src="../public/img/<?= $data['hinhanh'] ?>" alt="" style="width:180px;background-color:#f5f5f5">
                                </div>
                                <input type="file" name="img" id="" placeholder="Hình ảnh 1" class="form-control mb-3">
