<div class="row">
    <div class="col-12 col-lg-12">
        <div class="card">
            <div class="card-header">Bảng sửa loại dây
                ...
                <div class="page-addProduct">
                    <div class="form-wrap px-3 py-4">
                        <div class="main-form pt-3">
                            <form action="?act=loaiday&sub=update&condition=idLD" method="post" class="form-group" enctype="multipart/form-data">
                                <input type="hidden" name="id" placeholder="Mã sản phẩm" class="form-control mb-3" value="<?=$data['idLD']?>">
                                <input type="hidden" name="sub-id" value="idLD">
                               <div class="mb-3">
                                    <label for="">Tên loại dây</label>
                                    <input type="text" name="name" id="" value="<?= $data['tenLD'] ?>" placeholder="Tên loại dây" class="form-control mb-3">
                                    <input type="hidden" name="sub-name" value="tenLD">
                               </div>
                                <div class="img1 mb-3">
